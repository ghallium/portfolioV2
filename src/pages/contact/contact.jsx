          ...
          <div className="contact-pageblock mx-0 w-full lg:w-3/4 flex flex-col lg:flex-row justify-between lg:mx-auto">
            ...
            <div className="contactform-container w-11/12 mx-auto lg:mx-0 py-6 lg:w-2/3">
              ...
              <div className="flex flex-col items-center justify-center"></div>
                <form onSubmit={handleSubmit(onSubmit)} className="bg-zinc-200 dark:bg-zinc-700 opacity-0 text-base md:text-xl lg:text-2xl font-light p-6 rounded-lg w-full lg:w-2/3 mx-auto">
