              ...
              <div className="flex flex-col items-center justify-center"></div>
                <form onSubmit={handleSubmit(onSubmit)} className="bg-zinc-200 dark:bg-zinc-700 opacity-0 text-2xl font-light p-6 rounded-lg w-2/3 mx-auto">
                    ...
                    <label>Votre message :</label><br/>
                      ...
                      <div className="bg-ghgreen text-white w-28 text-center rounded-md hover:bg-zinc-500 hover:font-semibold hover:scale-105 transition-all px-2 py-3">
